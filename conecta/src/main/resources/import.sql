...
INSERT INTO demanda (id, requisitos, empresa_id, cantidad_Alumnos)
VALUES (nextval('demanda_seq'),'Necesito un software de gestión de proyectos.', 1, 151); -- Demanda para Empresa de Tecnología

INSERT INTO demanda (id, requisitos, empresa_id, cantidad_Alumnos)
VALUES (nextval('demanda_seq'),'Requiero servicios de consultoría en salud.', 51, 1); -- Demanda para Salud y Vida

INSERT INTO demanda (id, requisitos, empresa_id, cantidad_Alumnos)
VALUES (nextval('demanda_seq'),'Busco un proveedor de hardware.', 51, 51); -- Otra demanda para Empresa de Tecnología

INSERT INTO demanda (id, requisitos, empresa_id, cantidad_Alumnos)
VALUES (nextval('demanda_seq'),'Solicito formación en primeros auxilios.', 51, 201); -- Otra demanda para Salud y Vida
